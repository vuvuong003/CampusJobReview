          ...
          <div className="fixed inset-0 flex flex-col items-center justify-center mt-20">
            ...
            <div className="bg-white w-[40vw] h-[100vh] shadow-lg items-center justify-center p-10 overflow-y-auto">
              <form onSubmit={this.handleSubmit}>
                {/* Job Title Input */}
                <div className="mb-6">
                  <label htmlFor="job_title" className="block text-gray-700">
                    Job Title
                  </label>
                  <input
                    id="job_title"
                ...
                {/* Location Input */}
                <div className="mb-6">
                  <label htmlFor="locations" className="block text-gray-700">
                    Location
                  </label>
                  <input
                    id="locations"
                ...
                {/* Hourly Pay Input */}
                <div className="mb-6">
                  <label htmlFor="hourly_pay" className="block text-gray-700">
                    Hourly Pay
                  </label>
                  <input
                    id="hourly_pay"
