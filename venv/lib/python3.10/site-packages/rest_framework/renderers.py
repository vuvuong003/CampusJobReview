...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def get_default_renderer(self, view):
        ...
        non_template_renderers = [
            renderer for renderer in renderers if not hasattr(
                renderer, 'get_template_names')]
...
class DocumentationRenderer(BaseRenderer):
    ...
    def get_context(self, data, request):
        return {
            ...
            'lang_htmls': [
                "rest_framework/docs/langs/%s.html" %
                language for language in self.languages],
            'lang_intro_htmls': [
                "rest_framework/docs/langs/%s-intro.html" %
                language for language in self.languages],
            'code_style': pygments_css(
                self.code_style),
            'request': request}
