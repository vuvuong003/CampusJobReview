...
class Name:
    ...
    def to_unicode(self, omit_final_dot: bool = False,
                   idna_codec: Optional[IDNACodec] = None) -> str:
...
# we need 'dns.wire.Parser' quoted as dns.name and dns.wire depend on each
# other.
